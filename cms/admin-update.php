           ...
           <!-- content here!! -->
            ...
            <form role="form" action="<?php echo $page;?>-update.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="admin_type" type="radio" id="admin_type" value="Administrator" checked="checked" > Administrator <input name="admin_type" type="radio" id="admin_type" value="User" <?php if ($admin_type=='User'){ ?> checked="checked"<?php } ?> > User
                </div>  
                <div class="mb-3">
                    <label>
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2" onclick="javascript:window.location.href='<?php echo $page;?>.php';">Cancel</button>
                </div>
            </form>
