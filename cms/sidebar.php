...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/" target="_blank">
        <img src="assets/img/mbgt-logo.png" class="navbar-brand-img h-100" alt="main_logo">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  <?php echo $active_index;?>" href="index.php">
        ...
        <?php
						$s="SELECT * FROM `".$FTblName."_module` where ref_module_id = '0' and module_status = '1' order by module_rank asc ";
						#echo $s;
						$q = $mysqli->query($s);
							while ($r = $q->fetch_assoc()){
								$s1="SELECT * FROM `".$FTblName."_module` where ref_module_id = '".$r['module_id']."' and module_status = '1' order by module_rank asc ";
								#echo $s1;
								$q1 = $mysqli->query($s1);
								$qq1 = $mysqli->query($s1);
								if($r1 = $q1->fetch_assoc()){
									$show = true;
								}else{
									$show = false;
								} 
							if (($r['module_mode']=="System" && $_SESSION["login_group"]=="Administrator") || $r['module_mode']=="Structure"){

                if (preg_match("/".$r['module_module'].".php/i",$_SERVER['REQUEST_URI'])){
                  $active = "active";
                }else{
                  $active = "";
                }
        ...
        <li class="nav-item">
          <a class="nav-link  <?php echo $active;?>" href="<?php echo $r['module_module'];?>.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <?=$r['module_icon']?>
              
            </div>
            <span class="nav-link-text ms-1"><?php echo $r['module_name'];?></span>
          </a>
        </li>
        <?php }} ?>
        ...
        <!-- <li class="nav-item">
          <a class="nav-link  " href="feedback.php">
            ...
            <span class="nav-link-text ms-1">Course Feedback</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  <?php echo $active;?>" href="feedback.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
